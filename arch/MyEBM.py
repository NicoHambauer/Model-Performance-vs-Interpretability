...
class MyExplainableBoostingMixin(MyCommonBase):
    def __init__(self, random_state=1377, data_n_episodes=20000, n_estimators=16, feature_step_n_inner_bags=0,
        n_jobs=-1, learning_rate=None, min_cases_for_splits=2, binning_strategy='quantile',
        holdout_split=0.176, **kwargs):
        ...
        super(MyExplainableBoostingMixin, self).__init__(
            ...
            binning_strategy=binning_strategy, holdout_split=holdout_split, **kwargs)
